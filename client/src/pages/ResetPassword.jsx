        ...
        className='absolute left-5 sm:left-20 top-5 w-28 sm:w-32 cursor-pointer'/>
          ...
          <form onSubmit={onSubmitEmail} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
                ...
                <p className='text-center mb-6 text-indigo-300'>
                  Enter your Registered Email</p>
              <div className='flex items-center gap-3 rounded-full bg-[#333A5C] px-5 py-2.5 w-full mb-4'>
                <img src={assets.mail_icon} alt=""  className='w-3 h-3'/>
                <input type='text' placeholder='Enter your email' className='bg-transparent outline-none text-white' value={email} onChange={(e) => setEmail(e.target.value)} required/>
              </div>
              <button className='w-full py-3 bg-linear-to-r from-indigo-500 to-indigo-900 rounded-full text-white mt-3' >
                Submit
              </button>
